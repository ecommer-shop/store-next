...
export function AgendarDemoButton() {
  ...
  const currentMonthLabel = new Intl.DateTimeFormat(locale, { month: 'long', year: 'numeric' })
  ...
  const handleConfirm = () => {
    ...
    const message = t('schedule.whatsappMessage', {
      date: formattedDate,
  ...
  return (
    <>
      <button
        ...
        aria-label={t('schedule.openButton')}
