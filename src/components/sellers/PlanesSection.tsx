      ...
      <Reveal>
        <div className="container mx-auto px-4">
          ...
          <StaggerGrid className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-stretch" staggerDelay={0.12}>
            {/* Free */}
            <StaggerItem className="bg-white/60 dark:bg-[#12123F]/40 backdrop-blur-md border border-black/10 dark:border-[#F1F1F1]/10 rounded-2xl p-8 flex flex-col transition-all hover:border-black/12 dark:hover:border-[#F1F1F1]/20">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                <li className="flex items-center gap-3 text-sm text-[#12123F]/70 dark:text-[#F1F1F1]/70">
                  <Check className="w-4 h-4 text-[#6BB8FF] shrink-0" />
