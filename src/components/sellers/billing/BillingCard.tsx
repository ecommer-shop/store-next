            ...
            {displayPlans.map((plan: any) => {
                ...
                return (
                    <TiltCard key={plan.id} onClick={current ? undefined : handleRedirect}>
                        <Card
                            className={`h-100 relative border overflow-hidden bg-gradient-to-br ${meta.gradient} ${meta.shadow} 
                                ${current ? 'ring-2 ring-primary' : 'hover:shadow-xl hover:ring-2 hover:ring-primary/50'}
                                ...
                                <p className="text-3xl font-bold">
                                    {plan.price === 0 ? 'Gratis' : (
                                        <>
                                            ...
                                            <span className="text-sm font-normal text-muted-foreground">{t('Planes.perMonth')}</span>
                                        </>
                                    )}
                                </p>
